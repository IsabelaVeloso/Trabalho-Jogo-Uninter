...
class Score:
    ...
    def save(self, game_mode: str, player_score: list[int]):
        ...
        while True:
            self.score_text(30, 'Score', COLOR_DARK_GREEN, SCORE_POS['Title'])  
            ...
            for event in pygame.event.get():  
                if event.type == pygame.QUIT:
                    ...
                    if event.key == pygame.K_RETURN and len(name) == 4:
                        ...
                        try:
                            db_proxy.save(score_dict)  
                            self.show()
                            return
                            print(f'Dados a salvar: {score_dict}')  
    ...
    def show(self):
        ...
        for player_score in list_score:
            ...
            self.score_text(20, name, COLOR_DARK_GREEN, (SCORE_POS['NameColumn'][0], y_offset)) 
            self.score_text(20, f'{score:05d}', COLOR_DARK_GREEN, (SCORE_POS['ScoreColumn'][0], y_offset))  
            self.score_text(20, date, COLOR_DARK_GREEN, (SCORE_POS['DateColumn'][0], y_offset)) 
